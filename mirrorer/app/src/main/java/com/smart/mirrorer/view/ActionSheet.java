        ...
        if (titles != null) {
            for (int i = 0; i < titles.length; i++) {
                ...
                if (titles[i].equals("删除")) {
                    bt.setTextColor(getResources().getColor(R.color.app_red));
                } else {
...
//        bt.getPaint().setFakeBoldText(true);
    ...
    private static class Attributes {
        ...
        public Attributes(Context context) {
            ...
            this.padding = DeviceConfiger.dp2px(20);
            this.otherButtonSpacing = DeviceConfiger.dp2px(2);
            this.cancelButtonMarginTop = DeviceConfiger.dp2px(10);
            this.actionSheetTextSize = DeviceConfiger.dp2px(14);
        }
    ...
    public static class Builder {
        ...
        private ActionSheetListener mListener;
        private int btnTxtColor = Color.parseColor("#4fb4e9");
