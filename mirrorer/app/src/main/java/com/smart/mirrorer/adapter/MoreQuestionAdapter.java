 ...
 */
public class MoreQuestionAdapter extends CommonAdapter<QuestionListBean.ResultBean.ListBean> implements SwipeMenuCreator {

    private Context mContext;

    public MoreQuestionAdapter(Context ctx, int layoutId) {
        super(ctx, layoutId);
        mContext = ctx;
    }
