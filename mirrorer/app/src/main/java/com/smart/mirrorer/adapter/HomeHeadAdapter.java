...
public class HomeHeadAdapter extends RecyclerView.Adapter {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private com.smart.mirrorer.view.CornerImageView headIv;
        private TextView nameTv;
//        private View emptyView;
        private TextView head_cell_title_tv;

        public ViewHolder(View itemView) {
            super(itemView);

            headIv = (com.smart.mirrorer.view.CornerImageView) itemView.findViewById(R.id.head_cell_image);
...
//            emptyView = itemView.findViewById(R.id.head_cell_right_empty_view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.head_cell_title_tv.setText(itemData.getTitle());
