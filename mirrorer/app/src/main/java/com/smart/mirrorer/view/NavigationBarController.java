...
public class NavigationBarController {
    ...
    public void setImageTitle(int id) {
        TextView tvTitle = (TextView) View.inflate(mContext, R.layout.navigation_bar_title, null);
    ...
    public void setImageLeft(int id,View.OnClickListener listener) {
        ImageView tvTitle = new ImageView(mContext);
        tvTitle.setImageResource(id);
        RelativeLayout.LayoutParams fParams = new RelativeLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT,
                FrameLayout.LayoutParams.WRAP_CONTENT);
        tvTitle.setLayoutParams(fParams);
        int margin = DeviceConfiger.dp2px(4);
        int paddiing = DeviceConfiger.dp2px(10);
        fParams.leftMargin = margin;
        fParams.addRule(RelativeLayout.CENTER_VERTICAL);
        tvTitle.setPadding(paddiing,paddiing,paddiing,paddiing);
        tvTitle.setLayoutParams(fParams);
        tvTitle.setOnClickListener(listener);
        mNavigationBar.setLeftImage(tvTitle);
    }
    public void setImageRight(int id,View.OnClickListener listener) {
        ...
        tvTitle.setLayoutParams(fParams);
        tvTitle.setOnClickListener(listener);
        mNavigationBar.setRightImage(tvTitle);
    }
