...
public class NavigationBar extends RelativeLayout {
    ...
    public interface IProvideNavigationBar {
        ...
        public void setCommonImageTitle(int id);
        public void setCommonImageLeft(int id,View.OnClickListener listener);
        public void setCommonImageRight(int id,View.OnClickListener listener);
