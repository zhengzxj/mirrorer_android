...
//        TipsUtils.showShort(getApplicationContext(),"进入页面oncReate方法");
        ...
        L.e("FollowActivity : 获取isFollowType属性");
//        TipsUtils.showShort(getApplicationContext(),"获取isFollowType属性");
        if (isFollowType) {
    ...
    private void initView() {
        L.e("FollowActivity : 进入页面initView方法");
//        TipsUtils.showShort(getApplicationContext(),"进入页面initView方法");
        ...
        mAdapter.setVideoCallListener(new RecommonLikeFollowAdapter.ICallVideoListener() {
            ...
            public void playVideo(String videoUrl)
            {
                if (TextUtils.isEmpty(videoUrl)) {
                    TipsUtils.showShort(FollowActivity.this.getApplicationContext(), "暂无视频介绍");
                    return;
                }
...
//            L.i("XXXYYY创建订单结果 : response = "+response);
    ...
    private void callVideo(String orderId,JSONObject response) {
        ...
        Intent intent = new Intent(FollowActivity.this,CallingActivity.class);
    ...
    private void getRecommonList() {
        L.e("FollowActivity : 进入页面getRecommonList方法");
//        TipsUtils.showShort(getApplicationContext(),"进入页面getRecommonList方法");
        showLoadDialog();
    ...
    private void getFollowedList() {
        L.e("FollowActivity : 进入页面getFollowedList方法");
